...
> [!CAUTION]
You will need root/admin permissions on your Linux machine to modify the configuration files. <br/> 
...
> [!NOTE]
If the <ins>Save</ins> button is greyed out and you can't tap it, it means that the code is out of format; go back and re-copy it from the repo. <br/> 
...
#### Keyboard Shortcuts
- In certain situations, keyboard shortcuts won't work while using a Shavian XKB keyboard layout. The reasons for this are varied; certain applications, text fields, shortcuts, and permutations of those factors all contribute.
